...
if SellerAPI is None:
    class BotOzonClient:
        """Legacy compatibility stub when ozonapi is not installed."""

        def __init__(self, client_id: str, api_key: str):
            raise RuntimeError(
                "BotOzonClient requires the optional 'ozonapi' package. "
                "The main bot uses botapp.ozon_client and does not need it."
            )
else:
