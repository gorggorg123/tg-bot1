...
def main_menu_keyboard() -> InlineKeyboardMarkup:
    """Главное меню. Важно: держим «все разделы» на виду (Отзывы/Вопросы/Чаты/ФБО/Финансы/Склад)."""
    kb: list[list[InlineKeyboardButton]] = [
        [
            InlineKeyboardButton(
                text="📝 Отзывы",
                callback_data=MenuCallbackData(section="reviews", action="open", arg="").pack(),
            ),
            InlineKeyboardButton(
                text="❓ Вопросы",
                callback_data=MenuCallbackData(section="questions", action="open", arg="").pack(),
            ),
        ],
        [
            InlineKeyboardButton(
                text="💬 Чаты",
                callback_data=MenuCallbackData(section="chats", action="open", arg="").pack(),
            ),
        ],
        [
            InlineKeyboardButton(
                text="📦 ФБО",
                callback_data=MenuCallbackData(section="fbo", action="summary", arg="").pack(),
            ),
            InlineKeyboardButton(
                text="💰 Финансы",
                callback_data=MenuCallbackData(section="fin_today", action="open", arg="").pack(),
            ),
        ],
        [
            InlineKeyboardButton(
                text="🏭 Склад",
                callback_data=MenuCallbackData(section="warehouse", action="open", arg="").pack(),
            ),
        ],
        [
            InlineKeyboardButton(
                text="⚙️ Настройки",
                callback_data=MenuCallbackData(section="settings", action="open", arg="").pack(),
            ),
        ],
    ]
