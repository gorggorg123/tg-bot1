...
from botapp.ai_client import generate_answer_for_question
...
from botapp.ozon_client import OzonAPIError, has_write_credentials, send_question_answer
...
from botapp.storage import get_question_answer, upsert_question_answer
...
async def _show_question_card(
    *,
    ...
    markup = question_card_keyboard(category=category, page=page, token=token, can_send=can_send, has_answer=bool(q.has_answer or (q.answer_text or "").strip()))
