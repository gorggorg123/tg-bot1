...
async def get_orders_month_text(client: OzonClient | None = None) -> str:
    """Сводка FBO за текущий месяц без детальной динамики."""
