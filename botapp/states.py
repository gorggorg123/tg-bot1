...
class CdekStates(StatesGroup):
    waiting_conversation = State()  # Ожидание переписки
    confirming_data = State()  # Подтверждение извлеченных данных
    editing_data = State()  # Редактирование данных вручную


__all__ = ["QuestionAnswerStates", "ChatStates", "WarehouseStates", "CdekStates"]
